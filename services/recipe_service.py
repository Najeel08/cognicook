...
INGREDIENT_MATCH_ALIASES = {
    ...
    "cocoa powder": {"cocoa"},
    "coriander": {"coriander leaves", "coriander powder"},
    "coriander leaves": {"coriander"},
    "coriander powder": {"coriander"},
    "cumin": {"cumin seeds", "cumin powder"},
    "cumin powder": {"cumin", "cumin seeds"},
    "cumin seeds": {"cumin", "cumin powder"},
    "fennel": {"fennel seeds", "fennel powder"},
    "fennel powder": {"fennel", "fennel seeds"},
    "fennel seeds": {"fennel", "fennel powder"},
